...
public interface IOgctSourceAccessor
{
    ...
    /// <returns></returns>
    OgctDataSource OpenOrCreateDatasource(string? path, EAccessLevel accessLevel = EAccessLevel.ReadOnly, bool createIfNotExist = false, ESpatialRefWkt spRef = ESpatialRefWkt.None, wkbGeometryType geometryType = wkbGeometryType.wkbNone);
